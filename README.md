...
Проект был выполнен с частично готовым модулем, были использованы псевдоклассы и псевдоэлементы; код был написан с учетом доступности интерфейса, а также перепонением блоков, стилизацией форм и кнопок.

https://github.com/UndrW999/posmotri-v-okno-fd